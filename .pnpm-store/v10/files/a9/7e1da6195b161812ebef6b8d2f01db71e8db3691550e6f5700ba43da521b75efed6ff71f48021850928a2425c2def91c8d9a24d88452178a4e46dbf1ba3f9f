...
import { I as IsSignal, d as InferRoute, c as InferErrorCodes } from '../shared/better-auth.BtQaG5p3.cjs';
...
import { A as Auth, b as InferAPI } from '../shared/better-auth.C9FmyZ5W.cjs';
