...
const organization = require('../shared/better-auth.DYr090tl.cjs');
...
const admin = require('../shared/better-auth.BSohqXr-.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.DSM31lCn.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.1R2W7eH4.cjs');
...
require('../shared/better-auth.CO2claig.cjs');
