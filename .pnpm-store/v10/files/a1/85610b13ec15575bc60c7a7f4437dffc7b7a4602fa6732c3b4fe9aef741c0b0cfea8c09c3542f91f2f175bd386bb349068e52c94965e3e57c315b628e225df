...
import { I as IsSignal, d as InferRoute, c as InferErrorCodes } from '../shared/better-auth.YquOTugC.mjs';
...
import { A as Auth, b as InferAPI } from '../shared/better-auth.DWUgoamJ.mjs';
